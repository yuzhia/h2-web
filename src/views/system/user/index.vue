        ...
        <el-table v-loading="loading" :data="userList" @selection-change="handleSelectionChange">
          ...
          <el-table-column label="操作" align="center" width="180" class-name="small-padding fixed-width">
            <template #default="scope">
              ...
              <el-tooltip content="资料录入" placement="top" v-if="scope.row.userId !== 1">
                <el-button
                  link
                  type="primary"
                  icon="Document"
                  @click="handleUserProfile(scope.row)"
                  v-hasPermi="['system:user:edit']"></el-button>
              </el-tooltip>
            </template>
          </el-table-column>
...
// 跳转用户详情
const handleUserProfile = (row) => {
  router.push(`/personnal/user/profile/${row.userId}`)
}
