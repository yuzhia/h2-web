  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryRef" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="员工" prop="userId">
        <el-input v-model="queryParams.userId" placeholder="请输入员工" clearable @keyup.enter="handleQuery" />
      </el-form-item>
      <el-form-item label="所属公司" prop="companyId">
        <el-input v-model="queryParams.companyId" placeholder="请输入所属公司" clearable @keyup.enter="handleQuery" />
      </el-form-item>
      <el-form-item>
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button type="primary" plain icon="Plus" @click="handleAdd" v-hasPermi="['hr:change:add']">新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          type="success"
      ...
      <el-col :span="1.5">
        <el-button type="warning" plain icon="Download" @click="handleExport" v-hasPermi="['hr:change:export']">
          导出
        </el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="changeList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template #default="scope">
          <el-button link type="primary" icon="Edit" @click="handleUpdate(scope.row)" v-hasPermi="['hr:change:edit']">
            修改
          </el-button>
          <el-button
            link
      ...
      <el-form ref="changeRef" :model="form" :rules="rules" label-width="120px">
        <el-form-item label="项目名称" prop="name">
          <el-select v-model="form.salaryItemId" placeholder="请选择项目名称" size="default">
            <el-option v-for="item in itemTypeList" :key="item.id" :label="item.name" :value="item.id" />
          </el-select>
        </el-form-item>
        <el-form-item label="员工" prop="userId">
        ...
        <el-form-item label="异动前薪资" prop="salaryBeforeChange">
          <el-input-number
            v-model="form.salaryBeforeChange"
        ...
        <el-form-item label="异动后薪资" prop="salaryAfterChange">
          <el-input-number
            v-model="form.salaryAfterChange"
            controls-position="right"
            :min="0"
            :step="0.1"
            :precision="2" />
        ...
        <el-form-item label="异动时间" prop="changeTime">
          <el-date-picker v-model="form.changeTime" type="date" placeholder="选择时间" />
        </el-form-item>
...
function handleDelete(row) {
  ...
  proxy.$modal
    .confirm('是否确认删除薪资异动编号为"' + _ids + '"的数据项？')
    .then(function () {
